...
<ul>
        ...
        <li>Priority settings follow a traffic light system (red / high, yellow / medium, green / low). Tasks can be dragged between priority boxes to reassign their priority.</li>
        <li>Edit mode allows editing task titles. Saving each change is required.</li>
</ul>
